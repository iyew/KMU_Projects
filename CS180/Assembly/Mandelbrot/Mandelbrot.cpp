...
\date   26/9/2013
\brief  
  This is the basic window and zooming code for assignment 2 of CS180.
Students should not change this file (except for testing), because it 
won't be submitted.  
*/
/******************************************************************************/
#include <sstream>
...
Mandelbrot::Mandelbrot(HINSTANCE hinst, int show)
  ...
  window_area = 0.2f*GetSystemMetrics(SM_CXSCREEN)
...
void Mandelbrot::Render(HWND win) {
  ...
  for (int j=0; j < rect.right; ++j) {
    for (int i=0; i < rect.bottom; ++i) {
      ...
      COLORREF color = RenderPoint(x,y,5120);
